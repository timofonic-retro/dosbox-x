...
extern bool				dos_con_use_int16_to_detect_input = true;

extern bool				dbg_zero_on_dos_allocmem = true;
extern bool				dbg_zero_on_xms_allocmem = true;
extern bool				dbg_zero_on_ems_allocmem = true;
 ...
 *                 90MHz / 3 = 30.000MHz */
extern ClockDomain			clockdom_PCI_BCLK(100000000,3);		/* MASTER 100MHz / 3 = 33.33333MHz */

/* ISA bus OSC clock (14.31818MHz), using a crystal that is 4x the NTSC subcarrier frequency 3.5795454..MHz */
extern ClockDomain			clockdom_ISA_OSC(NTSC_COLOR_SUBCARRIER_NUM*4,NTSC_COLOR_SUBCARRIER_DEN);
...
extern ClockDomain			clockdom_ISA_BCLK(25000000,3);		/* MASTER 25000000Hz / 3 = 8.333333MHz */
...
xtern ClockDomain			clockdom_8254_PIT(NTSC_COLOR_SUBCARRIER_NUM,NTSC_COLOR_SUBCARRIER_DEN*3);
...
extern ClockDomain			clockdom_8250_UART(115200 * 16);

extern Config*				control;
extern MachineType			machine;
extern bool				PS1AudioCard;		// Perhaps have PS1 as a machine type...?
extern SVGACards			svgaCard;
extern bool				SDLNetInited;
extern Bit32s				ticksDone;
extern Bit32u				ticksScheduled;
extern bool				ticksLocked;
extern bool				mono_cga=false;
extern bool				ignore_opcode_63 = true;
extern bool				mainline_compatible_mapping = true;
extern bool				mainline_compatible_bios_mapping = true;
extern int				dynamic_core_cache_block_size = 32;
extern Bitu				VGA_BIOS_Size_override = 0;
extern Bitu				VGA_BIOS_SEG = 0xC000;
extern Bitu				VGA_BIOS_SEG_END = 0xC800;
extern Bitu				VGA_BIOS_Size = 0x8000;

extern static Bit32u			ticksRemain;
extern static Bit32u			ticksLast;
extern static Bit32u			ticksAdded;
extern static Bit32u			Ticks = 0;
extern static LoopHandler*		loop;
